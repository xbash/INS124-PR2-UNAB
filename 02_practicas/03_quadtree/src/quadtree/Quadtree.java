...
/**
 * Title: Proyecto 2 de Algoritmos y Programacion 2.
 *           Quadtree
 *
 * Description: Un quadtree es un formato utilizado para la representaci�n
 ...
 *                 un quadtree no es necesariamente un �rbol balanceado.
 *
...
public class Quadtree {
    ...
    /**
     * Retorna el color del nodo ra�z del <tt>Quadtree</tt>.
    ...
    /**
     * Retorna la cantidad de pixels negros de Qt cuya altura m�xima es maxAlt.
    ...
    /**
     * Devuelve el nodo ra�z del <tt>Quadtree</tt>.
     *@return	el nodo ra�z del <tt>Quadtree</tt>.
     */
    public Nodo getNodo() {
        return arbol;
    }
    ...
    /**
     * Devuelve el preorden generado apartir de la uni�n de dos
     * <tt>Quadtree</tt>'s.
     */
