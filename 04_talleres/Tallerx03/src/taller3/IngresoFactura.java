...
public class IngresoFactura extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Ingreso de facturas");
        ...
        EstadoPago.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "S", "N" }));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(EstadoPago, 0, 212, Short.MAX_VALUE))
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String glosa = jTextField4.getText();
        float neto = Float.parseFloat(jTextField5.getText());
        float iva = Float.parseFloat(jTextField6.getText());
        float total = Float.parseFloat(jTextField7.getText());
        String estado = EstadoPago.getSelectedItem().toString();
        
        String Query;
        Query ="INSERT INTO `Facturas` VALUES ('"+folio+"','"+rut+"','"+nombre+"','"+glosa+"',"+neto+","+iva+","+total+",'"+estado+"')";
