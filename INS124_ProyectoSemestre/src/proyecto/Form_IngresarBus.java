 ...
 * @author rgonzalez
 */
public class Form_IngresarBus extends javax.swing.JFrame {

    /**
     * Creates new form Form_IngresarBus
     */
    String patente,modelo;
    int ano,CantAsientos;
    
    public Form_IngresarBus() {
        initComponents();
    }
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addGroup(layout.createSequentialGroup()
                            ...
                            .addComponent(txtCantAsientos, javax.swing.GroupLayout.PREFERRED_SIZE, 252, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGroup(layout.createSequentialGroup()
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addComponent(txtAno, javax.swing.GroupLayout.PREFERRED_SIZE, 252, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addComponent(txtPatente, javax.swing.GroupLayout.PREFERRED_SIZE, 252, javax.swing.GroupLayout.PREFERRED_SIZE)))))
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        if (!ValidarPatente(patente)){
            ...
            String Query;
            Query = "INSERT INTO `buses` VALUES ('"+patente+"','"+modelo+"','"+ano+"','"+CantAsientos+"')";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Form_IngresarBus.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Form_IngresarBus().setVisible(true);
            }
        });
    }
     ...
     private boolean ValidarPatente(String patente){
        try{
            ClassMysql MysqlHandler= new ClassMysql();
            String query;
            query = "SELECT Patente from `Buses` WHERE Patente ='"+patente+"'";
